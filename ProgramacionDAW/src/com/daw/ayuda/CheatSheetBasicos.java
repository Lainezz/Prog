...
public class CheatSheetBasicos {
	...
	public static void main(String[] args) {
		...
		if(boolT != true | num5 > aux5 | num6 == 16) {
			// TRUE. Porque al menos una condición es true.
		...
		if(boolT == false && num5 <= aux5 && num6 < 100) {
			// No entra
		}
		// ¿boolT es igual a false? => false
