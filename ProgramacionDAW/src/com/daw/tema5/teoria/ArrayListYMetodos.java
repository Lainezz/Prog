...
public class ArrayListYMetodos {
	public static void main(String[] args) {
		...
		// Last index of -> te devuelve la última posición de un elemento que nosotros
		// le indicamos.
		arrStr.add("Fran"); // Añado un nuevo alumno
		System.out.println("Alumnos 1º: " + arrStr); // Mostramos por pantalla el array list
		System.out.println("La última posición de Fran es: " + arrStr.lastIndexOf("Fran")); // Muestro por pantalla la
																							// última posición de un
	...
	public static int sumar(int x, int y) {
		// Sumamos las dos variables que nos vienen por parámetros y las almacenamos en
		// resultado
		int resultado = x + y;
